...
void myLine(int x1, int y1, int x2, int y2, int R, int B, int G, int width = 2) //use three 3 integers if you want colored lines.
{
...
void myEllipse(int x1, int y1, int x2, int y2, int R, int G, int B, int width)
{
	HWND console_handle = GetConsoleWindow();
	HDC device_context = GetDC(console_handle);
